 ...
 */
var y = Symbol.for("react.element"), A = Symbol.for("react.portal"), F = Symbol.for("react.fragment"), N = Symbol.for("react.strict_mode"), V = Symbol.for("react.profiler"), q = Symbol.for("react.provider"), M = Symbol.for("react.context"), B = Symbol.for("react.forward_ref"), z = Symbol.for("react.suspense"), H = Symbol.for("react.memo"), W = Symbol.for("react.lazy"), $ = Symbol.iterator;
function J(e) {
...
function p(e, t, o) {
  this.props = e, this.context = t, this.refs = P, this.updater = o || j;
}
...
function D(e, t, o) {
  ...
  if (t != null) for (n in t.ref !== void 0 && (c = t.ref), t.key !== void 0 && (i = "" + t.key), t) I.call(t, n) && !T.hasOwnProperty(n) && (u[n] = t[n]);
  ...
  if (e && e.defaultProps) for (n in s = e.defaultProps, s) u[n] === void 0 && (u[n] = s[n]);
...
function _(e, t, o, n, u) {
  ...
  if (c) return c = e, u = u(c), e = n === "" ? "." + m(c, 0) : n, w(u) ? (o = "", e != null && (o = e.replace(x, "$&/") + "/"), _(u, t, o, "", function(a) {
    return a;
  })) : u != null && (k(u) && (u = Y(u, o + (!u.key || c && c.key === u.key ? "" : ("" + u.key).replace(x, "$&/") + "/") + e)), t.push(u)), 1;
  if (c = 0, n = n === "" ? "." : n + ":", w(e)) for (var s = 0; s < e.length; s++) {
    i = e[s];
    var f = n + m(i, s);
    c += _(i, t, o, f, u);
  }
  else if (f = J(e), typeof f == "function") for (e = f.call(e), s = 0; !(i = e.next()).done; ) i = i.value, f = n + m(i, s++), c += _(i, t, o, f, u);
...
r.cloneElement = function(e, t, o) {
  ...
  if (t != null) {
    if (t.ref !== void 0 && (i = t.ref, c = R.current), t.key !== void 0 && (u = "" + t.key), e.type && e.type.defaultProps) var s = e.type.defaultProps;
    for (f in t) I.call(t, f) && !T.hasOwnProperty(f) && (n[f] = t[f] === void 0 && s !== void 0 ? s[f] : t[f]);
  }
...
function U(e, t, o) {
  ...
  for (n in t) re.call(t, n) && !oe.hasOwnProperty(n) && (u[n] = t[n]);
  if (e && e.defaultProps) for (n in t = e.defaultProps, t) u[n] === void 0 && (u[n] = t[n]);
...
b.exports = h;
var ue = b.exports;
const ie = ({ label: e, onClick: t }) => ue.jsx("button", { type: "button", onClick: t, children: e });
export {
  ie as MyButton
};
